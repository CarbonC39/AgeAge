...
type Skill struct {
	...
	// Valid values: "direct", "atomic", "workflow" (legacy: "simple", "medium", "complex").
...
//
//   - map:    outputs: {answer: result, count: total}
//   - list:   outputs: [answer, summary]         → each var reads from "result"
//   - scalar: outputs: answer                    → {answer: result}
...
func (o *OutputsMap) UnmarshalYAML(value *yaml.Node) error {
	...
	case yaml.ScalarNode:
		if value.Value != "" {
			*o = OutputsMap{value.Value: "result"}
		}
	default:
...
type PipelineNode struct {
	...
	// Complexity selects the LLM model: "direct", "atomic", or "workflow".
